...
function openGmail() {
  const email = "bhaveshmeghwal5155@gmail.com";
...
function downloadCV() {
  ...
  link.href = "images/Bhavesh Resume.pdf"; // Path to your resume file
  link.download = "Bhavesh Meghwal Resume"; // Name for the downloaded file
